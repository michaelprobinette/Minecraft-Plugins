...
public class EconShop {
	 ...
	 * @param boolean1
	 */
	public void setAllItemsInfinite(boolean boolean1) {
	 ...
	 * @param boolean1
	 */
	public void setCanRestock(boolean boolean1) {
		canRestock = boolean1;
	}
	 ...
	 * @param boolean1
	 */
	public void setAllowBuying(boolean boolean1) {
	 ...
	 * @param boolean1
	 */
	public void setAllowSelling(boolean boolean1) {
	...
	public void update() {
		try {
			...
			plugin.log.log(Level.WARNING, "Shop \"" + name + "\" could not update.");
		}
	}
	 ...
	 * @param boolean1
	 */
	public void setUseMoney(boolean boolean1) {
		isUseMoney = boolean1;
	}
				...
				if (iter.isSubtyped()) {
					if (iter.getDurability() == item.getDurability()) {
						try {
							...
							plugin.log.log(Level.WARNING, "CodeRedLite could not update an item. " + e.getLocalizedMessage());
						}
						break;
					}
				}
